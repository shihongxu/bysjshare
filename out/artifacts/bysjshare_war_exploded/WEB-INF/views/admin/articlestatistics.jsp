...
<div id="centerbg" style=" width:86.35%; height: 500px; margin-left: 204px;">
    <div class="centerHead" style="height:40px;">
        <div style="margin-top:4px;margin-left: 10px;">
            <span style="font-size: 18px;color: #2F4056;">文章数据统计</span>
        </div>
    </div>
    <div class="datagrid">
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                {type:'numbers'}
                ,{type: 'checkbox'}
                ,{field:'articleName', title:'文章名称', width:234, sort: true}
                ,{field:'userName', title:'文章作者', templet: '#usernameTpl'}
                ,{field:'date', title: '文章发布时间', minWidth:120, sort: true}
                ,{field:'articleType', title:'文章类型'}
                ,{field:'commentNumber', title:'文章评论数'}
                ,{field:'viewsNumber', title:'文章阅读数'}
                ,{field:'articlePublish', title:'文章状态', width:110}
            ]]
            ,page: true//开启分页
        });
    });
