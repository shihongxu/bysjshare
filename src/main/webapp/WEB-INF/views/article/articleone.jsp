...
<div >
    ...
    <div class="acenter">
        ...
        <div style="width: 750px; margin-left: 70px;margin-top: 10px; background: #ffffff; border: 1px green solid;">
            <h1 style="font-size: 24px; margin-left: 19px;">${article.articleName}</h1>
            <div style="font-size: 13px; color: #4f4f4f;font-weight: 400;  line-height: 26px;overflow-x: auto; margin-left: 20px;">
                <span>文章类型:&nbsp;&nbsp;${article.articleType}</span><span id="publishDate"> &nbsp;&nbsp; &nbsp;发表时间:  </span><span>&nbsp;&nbsp; &nbsp;阅读:${article.viewsNumber}</span><span>&nbsp;&nbsp; &nbsp;评论:${article.commentNumber}</span>
            </div>
            <div id="imgUrl"></div>
            <hr>
            <div>
                <div style="margin-left: 3px; margin-right: 3px; margin-bottom: 10px; color: #4f4f4f;">
        ...
        $.ajax({
            ...
            success : function (data) {
                ...
                for(var i = 0; i < 11; i++){
                    ...
                    html += "<div style='margin-top:5px; margin-left:40px;'>"+ "<a class='ared' href="+ "/article/articletitle?articleUuid=" + listName[i].articleUuid + ">"+ listName[i].articleName +"</a> " +
